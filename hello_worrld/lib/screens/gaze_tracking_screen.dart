...
//   final WebSocketChannel _channel = WebSocketChannel.connect(Uri.parse("ws://192.168.137.:5000"));
...
//           double relativeX = gazeX - scrollOffset.dx;
//           double relativeY = gazeY - scrollOffset.dy;
...
//                 if (gazeX >= position.dx && gazeX <= position.dx + size.width &&
//                     gazeY >= position.dy && gazeY <= position.dy + size.height) {
...
// // class GazeTrackingScreenState extends State<GazeTrackingScreen> with WidgetsBindingObserver {
// //   CameraController? _controller;
// //   final WebSocketChannel _channel = WebSocketChannel.connect(Uri.parse("ws://192.168.137.191:5000"));
// //   bool _isSending = false;
// //   int _selectedCameraIndex = 0;
// //   double? _gazeX, _gazeY;
// //   double? _globalGazeX, _globalGazeY;
